-- Migration 007b: Fix contact_interactions column names
-- 007 used 'subject' and 'staff_user_id' but routes/crm.js uses 'title' and 'created_by'
-- Drop and recreate with correct column names to match the route layer
